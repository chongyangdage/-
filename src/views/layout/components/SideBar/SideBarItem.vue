<template>
 <!-- 没有声明children -->
  <el-menu-item v-if="!route.children" v-show="route.meta.dis" :index="route.meta.routeText" >
  ...
  <!-- 声明了children -->
  <el-submenu v-show="route.meta.dis" v-else-if="route.children.length>1" :index="route.meta.routeText">
    <template slot="title">
      <i :class="route.meta.routeIcon"></i>
  ...
  <!-- children只有一个 -->
  <el-menu-item v-show="route.meta.dis" v-else :index="route.children[0].meta.routeText" >
